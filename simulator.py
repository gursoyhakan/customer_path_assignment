...
input_file = "customers2000.txt"
output_file = 'customer2000out.txt'
...
for action_rate in [1, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3]:
    ...
    for key in base_action_constraints:
        action_constraints[key] = int(action_rate*base_action_constraints[key])
    # ##### STATIC OPTIMIZATION #######
    ...
    simulation_customer_number = 2000
    static_ratio = 0.1
